...
CREATE TABLE `t_d_product_prd` (
  ...
  `PRD_DEFINITION` varchar(500) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(1, 1, 2, 'produit 1', 24, NULL, '120.44', NULL),
(2, 2, 2, 'produit 2', 18, NULL, '100.00', NULL),
(3, 3, 2, 'produit 3', 18, NULL, '99.99', NULL),
(4, 4, 2, 'produit 4', 36, NULL, '500.00', NULL),
(5, 5, 2, 'produit 5', 24, NULL, '320.58', NULL),
(6, 2, 1, 'produit6', 24, NULL, '30.55', NULL),
(7, 3, 1, 'produit7', 24, NULL, '55.55', NULL),
(8, 4, 1, 'produit8', 24, NULL, '499.99', NULL);
...
(1, 1, 'exemple@exemple.fr', 'password1', 'Dupont', 'Jean', NULL),
(2, 3, 'exemple2@exemple.fr', 'password2', 'Louis', 'Emile', NULL),
(3, 4, 'exemple3@exemple.fr', 'password3', 'Dutroux', 'Marc', NULL),
(4, NULL, 'fff@fff.fr', '3b2285b348e95774cb556cb36e583106', 'Magali', 'Prost', 'Lili'),
(5, NULL, 'ghghgh@grmail.fr', '3b2285b348e95774cb556cb36e583106', 'Prost', 'Magali', 'Lili1'),
(6, NULL, 'ggg@ggg.fr', '3b2285b348e95774cb556cb36e583106', 'lilia', 'lilia', 'lilia'),
(7, NULL, 'dddd@dddd.fr', '95c6b2ae4c3313e6fc1d0ab76f9c7df7', 'Gwen', 'leNul', 'gwennullos');
